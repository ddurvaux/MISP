 ...
 */
	public function view($id = null) {
		...
		$public = $this->Auth->user('email') == "public";
		if ( (!$this->_isSiteAdmin() && $this->Auth->user('id') != $id) || $public ) {
 ...
 */
	public function edit($id = null) {
		...
		if ( (!$this->User->exists() && !$me && !$this->_isSiteAdmin() && !($this->_isAdmin() && $this->Auth->user('org') == $this->User->data['User']['org'])) || $public ) {
			throw new NotFoundException(__('Invalid user or not authorised.'));
		}
