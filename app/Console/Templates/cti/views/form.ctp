...
<?php
		...
		foreach ($fields as $field) {
			if (strpos($action, 'add') !== false && $field == $primaryKey) {
				continue;
			} elseif(in_array($field, array('description', 'info'))){
				echo "\t\techo \$this->Form->input('{$field}', array('class' => 'input-xxlarge', 'div' => 'clear'));\n";
...
<?php
	echo "<?php echo \$this->Form->button(__('Submit'), array('class' => 'btn btn-primary')); ?>\n";
