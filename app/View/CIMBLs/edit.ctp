...
<?php echo $this->Form->create('CIMBL'); ?>
    <fieldset>
        <legend><?php echo __('Edit CIMBL'); ?></legend>
    <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CIMBL.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CIMBL.id'))); ?></li>
