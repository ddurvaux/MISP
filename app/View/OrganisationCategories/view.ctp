<div class="organisationCategories view">
<h2><?php  echo __('Organisation Category'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($organisationCategory['OrganisationCategory']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($organisationCategory['OrganisationCategory']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Organisation Category'), array('action' => 'edit', $organisationCategory['OrganisationCategory']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Organisation Category'), array('action' => 'delete', $organisationCategory['OrganisationCategory']['id']), null, __('Are you sure you want to delete # %s?', $organisationCategory['OrganisationCategory']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($organisationCategory['Organisation'])){ ?>
	...
	<?php
		$i = 0;
		foreach ($organisationCategory['Organisation'] as $organisation){ ?>
		<tr>
