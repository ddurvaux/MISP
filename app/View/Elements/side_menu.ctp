		...
		<?php
			...
			switch ($menuList) {
				...
				case 'globalActions':
					...
					<li <?php if ($menuItem === 'view') echo 'class="active"';?>> <?php if(!$isPublic) echo '<a href="/users/view/me">My Profile</a>';?></li>
					<li <?php if ($menuItem === 'members') echo 'class="active"';?>> <?php if(!$isPublic) echo '<a href="/users/memberslist">Members List</a>';?></li>
					<li <?php if ($menuItem === 'roles') echo 'class="active"';?>> <?php if(!$isPublic) echo '<a href="/roles/index">Role Permissions</a>';?></li>
					...
					<li <?php if ($menuItem === 'statistics') echo 'class="active"';?>> <?php if(!$isPublic) echo '<a href="/users/statistics">Statistics</a>';?></li>
					<?php 
				break;
