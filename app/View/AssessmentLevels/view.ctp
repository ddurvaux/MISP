<div class="assessmentLevels view">
<h2><?php  echo __('Assessment Level'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($assessmentLevel['AssessmentLevel']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($assessmentLevel['AssessmentLevel']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Definition'); ?></dt>
		<dd>
			<?php echo h($assessmentLevel['AssessmentLevel']['definition']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Assessment Level'), array('action' => 'edit', $assessmentLevel['AssessmentLevel']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Assessment Level'), array('action' => 'delete', $assessmentLevel['AssessmentLevel']['id']), null, __('Are you sure you want to delete # %s?', $assessmentLevel['AssessmentLevel']['id'])); ?> </li>
