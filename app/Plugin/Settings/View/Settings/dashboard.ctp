			...
			<ul class="dash">
				<li>
					<a href="#" title="Write a new article" class="tooltip">
						<?php echo $this->Html->image('icons/8_48x48.png');?>
						<span>New article</span>
					</a>
				</li>
				<li>
					<a href="#" title="What your team posted" class="tooltip">
						<?php echo $this->Html->image('icons/7_48x48.png');?>
						<span>Last articles</span>
					</a>
				</li>
				<li>
					<a href="#" title="Manage users and accounts" class="tooltip">
						<?php echo $this->Html->image('icons/16_48x48.png');?>
						<span>Users</span>
					</a>
				</li>
				<li>
					<a href="#" title="Your site's statistics" class="tooltip">
						<?php echo $this->Html->image('icons/4_48x48.png');?>
						<span>Statistics</span>
					</a>
				</li>
				<li>
					<a href="#" title="Bandwidth and traffic" class="tooltip">
						<?php echo $this->Html->image('icons/14_48x48.png');?>
						<span>Bandwidth</span>
					</a>
				</li>
				<li>
					<a href="#" title="Server warnings" class="tooltip">
						<?php echo $this->Html->image('icons/15_48x48.png');?>
						<span>Server warnings</span>
					</a>
				</li>
				<li>
					<a href="#" title="Manage downloads" class="tooltip">
						<?php echo $this->Html->image('icons/13_48x48.png');?>
						<span>Downloads</span>
					</a>
				</li>
				<li>
					<a href="#" title="Lorem ipsum" class="tooltip">
						<?php echo $this->Html->image('icons/19_48x48.png');?>
						<span>Listings</span>
					</a>
				</li>
				<li>
					<a href="#" title="Users' photo gallery" class="tooltip">
						<?php echo $this->Html->image('icons/1_48x48.png');?>
						<span>Gallery</span>
					</a>
				</li>
				<li>
					<a href="#" title="0 new messages" class="tooltip">
						<?php echo $this->Html->image('icons/25_48x48.png');?>
						<span>Inbox</span>
					</a>
				</li>
				<li>
					<a href="#" title="Browse for files" class="tooltip">
						<?php echo $this->Html->image('icons/21_48x48.png');?>
						<span>File browser</span>
					</a>
				</li>
				<li>
					<a href="#" title="Calculator" class="tooltip">
						<?php echo $this->Html->image('icons/30_48x48.png');?>
						<span>Calculator</span>
					</a>
				</li>
				<li>
					<a href="#" title="RSS Feeds" class="tooltip">
						<?php echo $this->Html->image('icons/29_48x48.png');?>
						<span>Feeds</span>
					</a>
				</li>
				<li>
					<a href="#" title="Lorem ipsum" class="tooltip">
						<?php echo $this->Html->image('icons/20_48x48.png');?>
						<span>Media</span>
					</a>
				</li>
				<li>
					<a href="#" title="Lorem ipsum" class="tooltip">
						<?php echo $this->Html->image('icons/26_48x48.png');?>
